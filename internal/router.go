...
import (
	...
	"open-replays/api/internal/db/sqlc"
	"open-replays/api/internal/domain"
	"open-replays/api/internal/stringutil"
)
...
func New() *gin.Engine {
	...
	r.DELETE("/api/v1/videos/:filename", func(c *gin.Context) {
		filename := c.Param("filename")
